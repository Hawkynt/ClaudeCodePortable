@echo off
REM ==========================================================================
REM  ClaudeCodePortable -- HappyCoder bootstrap (Windows)
REM    Same portable Node / runtime story as Claude.bat, but hands off to
REM    launcher/happy-launcher.mjs. That launcher installs happy-coder into
REM    the active profile's npm-global dir and then runs `happy`, which wraps
REM    Claude Code and exposes the session for remote mode.
REM ==========================================================================
...
"%NODE_BIN%\node.exe" "%PORTABLE_ROOT%\launcher\happy-launcher.mjs" %*
endlocal
exit /b %ERRORLEVEL%
